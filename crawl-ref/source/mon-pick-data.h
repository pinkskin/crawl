...
{ // Dis
  // "basic" monsters
  {  1,  7,  400, FALL, MONS_ANCIENT_CHAMPION },
  {  1,  7,  400, FALL, MONS_WAR_GARGOYLE },
  {  1,  7,  200, FALL, MONS_IRON_DRAGON },
  // "cross-hell" threats
...
{ // Cocytus
  ...
  {  1,  7,   10, FLAT, MONS_DREAD_LICH },
  // "branch flavour" threats
  {  1,  7,  300, PEAK, MONS_TITAN }, // Antaeus brought pals
  {  1,  7,  300, PEAK, MONS_WENDIGO },
  {  1,  7,  300, PEAK, MONS_NARGUN },
  {  1,  7,   50, FLAT, MONS_AZURE_JELLY },
  // "top tier" signature threats
  {  1,  7,  400, RISE, MONS_SHARD_SHRIKE },
  {  1,  7,  200, RISE, MONS_ICE_FIEND },
},

{ // Tartarus
  // "basic" monsters
  {  1,  7,  800, FALL, MONS_SPECTRAL_THING },
  {  1,  7,  100, FALL, MONS_SHADOW_WRAITH },
  {  1,  7,  100, FALL, MONS_REVENANT },
  // "cross-hell" threats
  {  1,  7,  100, FLAT, MONS_HELLION },
  {  1,  7,  100, FLAT, MONS_TORMENTOR },
  {  1,  7,   10, FLAT, MONS_ANCIENT_LICH },
  {  1,  7,   10, FLAT, MONS_DREAD_LICH },
  // "branch flavour" threats
  {  1,  7,  300, PEAK, MONS_BONE_DRAGON },
  {  1,  7,  300, PEAK, MONS_DOOM_HOUND },
  {  1,  7,  300, PEAK, MONS_PUTRID_MOUTH },
